    ...
    return (
        <div className="nav">
            ...
            <div className="navigation">
                ...
                <a className="navLinks" target="_blank" rel="noreferrer" href="https://docs.google.com/document/d/1j-O1gi_dqOeUpq31YQ2F0szdjtfDIdEBdZKh3kt3CsY/edit?usp=sharing"><h2>Resume</h2></a>
            </div>
        </div>
    )
}
